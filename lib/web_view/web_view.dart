...
class WebViewWidget extends StatelessWidget {
  ...
  WebViewWidget({this.key, this.controller});
    ...
    return Container(
      ...
      child: WebView(
        ...
        navigationDelegate: (NavigationRequest request) {
          if (request.url.startsWith('https://www.mapbox.com/') || (request.url.startsWith("https://www.openstreetmap.org/"))) {
